...
* 📝 **Summarize:** Condense text or documents (PDF/TXT)
* ✉️ **Email:** Generate professional email drafts
* ✓ **Todo:** Manage your tasks and to-do items
* 🌐 **Translate:** Convert text between languages
* 💻 **Code:** Get programming assistance
...
app.add_middleware(
    ...
    allow_origins=[
        ...
        "https://personal-ai-agent-ky4t3q74b-sai-ps-projects-51a2ed36.vercel.app",
